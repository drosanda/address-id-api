<?php
class kecamatan extends JI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->setTheme('front');
        $this->load('api/d_kecamatan_model', "dkm");
    }
    ...
    public function get()
    {
        ...
        $kabkota = $this->input->request("kabkota");
        if (empty($kabkota)) {
            $kabkota="";
        }
        ...
        $data = $this->dkm->getSearch($d_kabkota_id, $kabkota, $keyword);
        $this->__json_out($data);
    }
}
